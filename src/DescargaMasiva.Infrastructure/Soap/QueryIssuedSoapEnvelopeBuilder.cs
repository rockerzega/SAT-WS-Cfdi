...
internal sealed class QueryIssuedSoapEnvelopeBuilder : ISoapEnvelopeBuilder<QueryRequest>
{
  private readonly X509Certificate2? _defaultCertificate;

  public QueryIssuedSoapEnvelopeBuilder(X509Certificate2? defaultCertificate)
  {
