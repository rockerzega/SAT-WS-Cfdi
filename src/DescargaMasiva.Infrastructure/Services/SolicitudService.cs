...
public sealed class SolicitudService : ISolicitudService
{
  ...
  {
    return await _httpSoapClient.SendRequestAsync(WsUri.QueryUri,
      WsUri.QuerySoapActionIssuedUri,
      accessToken,
      soapRequestContent,
      cancellationToken);
  }
                                                          ...
                                                          CancellationToken cancellationToken = default)
  {
    ...
    SoapRequestResult soapRequestResult = await _httpSoapClient.SendRequestAsync(WsUri.QueryUri,
      WsUri.QuerySoapActionIssuedUri,
