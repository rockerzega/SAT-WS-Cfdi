...
public sealed class AutenticacionService : IAutenticacionService
{
  ...
  {
    return await _httpSoapClient.SendRequestAsync(WsUri.AuthUri,
      WsUri.AuthSoapActionUri,
                                                              ...
                                                              CancellationToken cancellationToken = default)
  {
    ...
    SoapRequestResult soapRequestResult = await _httpSoapClient.SendRequestAsync(WsUri.AuthUri,
      WsUri.AuthSoapActionUri,
      AccessToken.CreateEmpty(),
      soapRequestContent,
      cancellationToken);
