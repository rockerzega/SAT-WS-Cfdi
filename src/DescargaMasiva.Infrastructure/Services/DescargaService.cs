...
namespace DescargaMasiva.DescargaMasiva.Infrastructure.Services;
...
public sealed class DescargaService : IDescargaService
{
  ...
  {
    return await _httpSoapClient.SendRequestAsync(WsUri.DownloadUri,
      WsUri.DownloadSoapActionUri,
      accessToken,
      soapRequestContent,
      cancellationToken);
  }
                                                         ...
                                                         CancellationToken cancellationToken = default)
  {
    ...
    SoapRequestResult soapRequestResult = await _httpSoapClient.SendRequestAsync(WsUri.DownloadUri,
      WsUri.DownloadSoapActionUri,
