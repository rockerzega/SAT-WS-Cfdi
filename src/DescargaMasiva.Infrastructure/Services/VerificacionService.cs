...
public sealed class VerificacionService : IVerificacionService
{
  ...
  {
    return await _httpSoapClient.SendRequestAsync(WsUri.VerifyUri,
      WsUri.VerifySoapActionUri,
      accessToken,
      soapRequestContent,
      cancellationToken);
  }
                                                             ...
                                                             CancellationToken cancellationToken = default)
  {
      ...
      SoapRequestResult soapRequestResult = await _httpSoapClient.SendRequestAsync(WsUri.VerifyUri,
        WsUri.VerifySoapActionUri,
